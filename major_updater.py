#!/usr/bin/python
# finds computers that have major updates
# users must be admin
# pops open install macOS thing.app
...
FIRSTPOP = '''Your macOS is out of date by at least one (1) year.

You have privlidges to run the updater.

Press the Updater App button below, and then Press continue on the macOS Updater screen. Once you have completed the update you will no longer recieve this warning'''
FIRSTPOPBTN = 'Updater App'
# FIRSTPOP = '''Your computer needs updates, you have the privlidges to do them! Go to the APPLE MENU and choose System Preferences... Updates. 

#     Once You are Up To Date you will no longer recieve this WARNING...'''
